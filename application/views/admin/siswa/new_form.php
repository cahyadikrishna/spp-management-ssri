                            ...
                            <div class="card-body">
                                <h4 class="card-title">NISN</h4>
                                    <div class="form-group">
                                         <input type="number" class="form-control <?php echo form_error('nisn') ? 'is-invalid':'' ?>" id="placeholder"
                                            placeholder="Masukan NSIN" name="nisn">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alamat</h4>
                                    <div class="form-group">
                                        <textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>" rows="1" name="alamat" placeholder="Tulis alamat..."></textarea>
                                ...
                                <h4 class="card-title">Nomor Telp</h4>
                                    <div class="form-group">
                                        <input type="number" class="form-control <?php echo form_error('no_telp') ? 'is-invalid':'' ?>" id="placeholder"
                                            placeholder="Masukan No Telp" name="no_telp">
                                             <div class="invalid-feedback">
