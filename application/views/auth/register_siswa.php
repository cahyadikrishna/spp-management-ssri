            ...
            <div class="auth-box row text-center">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Registrasi Siswa</h2>
                        <form action="<?php echo site_url('admin/registrasi/siswa'); ?>" method="post" class="mt-4">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Nama Siswa" id="username" name="username" value="<?php echo set_value('username'); ?>">
